...
namespace ZeroKWeb
{
    public partial class UnlocksAdmin : System.Web.UI.Page
    {
        ...
        protected void DataSource_Deleting(object sender, EntityDataSourceChangingEventArgs e)
        {
            var db = new ZkDataContext();
            var unlock = db.Unlocks.Single(x => x.UnlockID == ((Unlock)e.Entity).UnlockID);
