...
<div id='<%=mission.MissionID%>' class='mission left' onclick='window.location="<%= Url.Action("Detail", new {id= mission.MissionID}) %>"' >
	...
	<img width='96' height='96' border='1' src='<%=Url.Action("Img", new { name = mission.Name })%>' class='left' />
	<p>This is the most missiony mission that has ever been missioned. On this mission ...
		<br />
