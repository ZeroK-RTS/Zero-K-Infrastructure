...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<p class="border">
		...
		Manual download: <a href='<%= Url.Action("File", "Missions", new {name=m.Name}) %>'><%= m.SanitizedFileName %></a> and <a href='<%=Url.Action("Script","Missions", new {id=m.MissionID})%>'>script.txt</a>
