...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="wrapper">
		...
		%>
		<p class="border">
			<%=Html.Encode(Model.Mission.Description).Replace("\n","<br/>")%>
			<br />
			<br />
			Players: <%=m.MinToMaxHumansString%><br />
			<small>
				<%=string.Join("<br/>", m.GetPseudoTags().ToArray())%></small><br />
			Map:
			<%=m.Map%><br />
			Game:
		...
		<div class="border">
			...
			<ol>
				...
				<li>
					<%=score.Score%>
					<%= Html.PrintAccount(score.Account)%>
