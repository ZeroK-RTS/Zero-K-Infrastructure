...
namespace ZeroKWeb.ForumParser
{
    ...
    public class ImgOpenTag: OpeningArgsTag<ImgCloseTag>
    {
        ...
        protected override bool ValidateArgs(ParseContext context, string args) => args.Length == 0 || args.Substring(1, args.Length - 1).IsValidLinkOrRelativeUrl(true);
        ...
        public override LinkedListNode<Tag> Translate(TranslateContext context, LinkedListNode<Tag> self) {
            ...
            if (url.IsValidLinkOrRelativeUrl(true)) context.AppendFormat("<a href=\"{0}\" target=\"_blank\" ><img src=\"{0}\" max-width=\"100%\" height=\"auto\"/></a>", url);
