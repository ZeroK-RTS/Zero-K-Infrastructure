...
namespace ZeroKWeb.Controllers
{
  public class MapsController: Controller
  {
                              ...
                              )
    {
      ...
      else if (size == 2) ret = ret.Where(x => Math.Sqrt((x.MapHeight*x.MapHeight + x.MapWidth*x.MapWidth)??0) > 16 && Math.Sqrt((x.MapHeight*x.MapHeight + x.MapWidth*x.MapWidth)??0) <= 24);
