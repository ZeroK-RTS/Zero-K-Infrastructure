    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Aliases = c.String(maxLength: 8000, unicode: false),
                ...
                c => new
                    {
                        ...
                        TurnsTotal = c.Int(),
                        TreatyNote = c.String(maxLength: 1000),
                    })
                ...
                c => new
                    {
                        ...
                        CampaignID = c.Int(),
                        AccountID = c.Int(nullable: false),
                        ModOptions = c.String(maxLength: 4000),
                        ...
                        MissionRunCount = c.Int(nullable: false),
                        IsDeleted = c.Boolean(nullable: false),
                        ManualDependencies = c.String(maxLength: 1000),
                        Rating = c.Single(),
                        Difficulty = c.Single(),
                ...
                c => new
                    {
                        ...
                        DescriptionStory = c.String(maxLength: 4000),
                ...
                c => new
                    {
                        ...
                        RequiredValue = c.String(nullable: false, maxLength: 500),
                    })
            ...
            CreateTable(
                ...
                c => new
                    {
                        VarName = c.String(nullable: false, maxLength: 200),
                        VarValue = c.String(),
                    })
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Account", new[] { "LobbyID" });
