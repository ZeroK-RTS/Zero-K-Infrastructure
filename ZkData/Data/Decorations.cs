namespace ZkData
{
  ...
  partial class CommanderDecoration
  {
    ...
    {
        return GetIconPosition((CommanderDecorationIcon)decoration.CommanderDecorationIcon);
    }

    public static string GetIconPosition(CommanderDecoration decoration)
    {
        return GetIconPosition((CommanderDecorationIcon)decoration.Unlock.CommanderDecorationIcon);
    }
  }
}
