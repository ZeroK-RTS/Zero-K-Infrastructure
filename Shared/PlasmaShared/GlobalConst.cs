            ...
            switch (newMode) {
                case ModeType.Local:
                    ...
                    ZkDataContextConnectionString =
                        "Data Source=(LocalDb)\\MSSQLLocalDB;Initial Catalog=zero-k_local;Integrated Security=True;MultipleActiveResultSets=true;Min Pool Size=5;Max Pool Size=2000;";
