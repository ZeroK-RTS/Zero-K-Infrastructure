...
.wdb_item
{
   ...
   background-image:url(panel_bg1.png);
...
.wdb_wname a:link { color: #ffba00; text-decoration: none; }
.wdb_wname a:visited { color: #ffba00; text-decoration: none; }
.wdb_wname a:focus { color: #ffba00; text-decoration: none; }
.wdb_wname a:hover { color: #ffba00; text-decoration: none; }
.wdb_wname a:active { color: #ffba00; text-decoration: none; }
...
//-WidgetIcons
  ...
  if ( isset( $_GET['s'] ) )
  {
   ...
   foreach ($widgetArray as $widget)
   {
      ...
      echo "\t\t<a href=\"http://spring.vsync.de/luaManager/lua_manager.php?m=10&id=" . $widget['Id'] . "\" title='Download widget as ZIP file'><img src='download.png' /></a>\n";
