...
namespace PlanetWars.MapIcons
{
    public partial class TransitIcon: UserControl, IUpdatable
    {
        ...
        public void Update()
        {
            ...
            if (String.IsNullOrEmpty(OwnerNameBlock.Text)) OwnerNameBlock.Text = mapTab.StarMap.Players.Single(p => p.PlayerID == transit.Fleets.OwnerID).Name; // todo: optimization: dont use linear search
