...
namespace ZeroKLobby.Notifications
{
    public partial class NotifyBarContainer: UserControl
    {
        ...
        public NotifyBarContainer(INotifyBar barContent)
        {
            ...
            int newHeight = DpiMeasurement.ReverseScaleValueY(control.Height); //get old height. Note: DpiMeasurement is a static class stored in ZeroKLobby\Util.cs
            //--
            Height = newHeight + 8; // apply height + margin (the height will again be automatically be scaled up according to Window's DPI) 
