...
{
    public class SecureSaidLine: IChatLine //the composer of each line of chat message
    {
        public string AuthorName { get; set; }
        public DateTime Date { get; set; }
        public string Message { get; set; }

        public SecureSaidLine(string author, [NotNull] string message, DateTime? date = null)
        {
            ...
            Text = TextColor.Text + "[" + TextColor.Date + Date.ToShortTimeString() + TextColor.Text + "] " + icon + " " + 
                (TextColor.ColorChar + "03") //green name to somewhat indicate encrypted line
