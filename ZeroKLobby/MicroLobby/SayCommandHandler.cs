        ...
        void client_Saying(object sender, SayingEventArgs e)
        {
            if (e.Text.Length > 0 && e.Text[0] == '/')
            {
                ...
                else
                {
                    ...
                    else if ((words[0] == "/pm" || words[0] == "/msg" || words[0] == "/message" || words[0] == "/w") && words.Length > 2) Program.TasClient.Say(SayPlace.User, words[1], PlasmaShared.Utils.Glue(words, 2), false);
