...
{
    // Custom scrollbar from "How to skin scrollbars for Panels, in C#", Greg Ellis, 13 Jul 2006
    ...
    public class CustomScrollbar : UserControl
    {
        ...
        public CustomScrollbar()
        {
            ...
            UpArrowImage = ScrollbarSkin.uparrow;
            DownArrowImage = ScrollbarSkin.downarrow;


            ThumbBottomImage = ScrollbarSkin.ThumbBottom;
            ThumbBottomSpanImage = ScrollbarSkin.ThumbSpanBottom;
            ThumbTopImage = ScrollbarSkin.ThumbTop;
            ThumbTopSpanImage = ScrollbarSkin.ThumbSpanTop;
            ThumbMiddleImage = ScrollbarSkin.ThumbMiddle;
