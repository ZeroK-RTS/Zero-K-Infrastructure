                    ...
                    if (founder.IsZkLobbyUser)
                    {
                            ...
                            battle.EngineVersion != client.ServerSpringVersion + ".0")
                        {
                            client.Say(TasClient.SayPlace.User,
                                       user.Name,
                                       string.Format(
                                           "ALERT! You need {0} engine to play here. Join the game with Zero-K lobby ( http://zero-k.info/Wiki/Download ) or get the engine from http://springrts.com/dl/buildbot/default/ or build it on your Linux: http://springrts.com/wiki/Building_Spring_on_Linux",
