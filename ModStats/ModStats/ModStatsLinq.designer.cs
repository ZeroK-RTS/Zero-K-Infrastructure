...
namespace ModStats
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="ModStats")]
	public partial class ModStatsLinqDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteGame(Game instance);
		...
		public ModStatsLinqDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["ModStatsConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public ModStatsLinqDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ModStatsLinqDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ModStatsLinqDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ModStatsLinqDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnParalyzeChanged();
		...
		[Column(Storage="_AttackerUnit", DbType="VarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_VictimUnit", DbType="VarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Name="Damage", Storage="_Damage1", DbType="Float NOT NULL")]
		...
		[Column(Storage="_Paralyze", DbType="Float NOT NULL")]
		...
		[Association(Name="Game_Damage", Storage="_Game", ThisKey="GameID", OtherKey="GameID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Game Game
		{
			get
			{
    ...
    partial void OnHealthChanged();
		...
		[Column(Name="Unit", Storage="_Unit1", DbType="VarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string Unit1
		{
			get
			{
		...
		[Column(Storage="_Created", DbType="Int NOT NULL")]
		public int Created
		{
			get
			{
		...
		[Column(Storage="_Destroyed", DbType="Int NOT NULL")]
		...
		[Column(Storage="_Health", DbType="Int NOT NULL")]
		public int Health
		{
			get
			{
		...
		[Association(Name="Game_Unit", Storage="_Game", ThisKey="GameID", OtherKey="GameID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Game Game
		{
			get
			{
    ...
    partial void OnPlayerListChanged();
		...
		[Column(Storage="_SpringGameIDString", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Mod", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string Mod
		{
			get
			{
		...
		[Column(Storage="_Players", DbType="Int NOT NULL")]
		public int Players
		{
			get
			{
		...
		[Column(Storage="_Teams", DbType="Int NOT NULL")]
		public int Teams
		{
			get
			{
		...
		[Column(Storage="_Version", DbType="Float NOT NULL")]
		...
		[Column(Storage="_Map", DbType="VarChar(100)")]
		public string Map
		{
			get
			{
		...
		[Column(Storage="_PlayerList", DbType="VarChar(2000)")]
		...
		[Association(Name="Game_Damage", Storage="_Damages", ThisKey="GameID", OtherKey="GameID")]
		...
		[Association(Name="Game_Unit", Storage="_Units", ThisKey="GameID", OtherKey="GameID")]
